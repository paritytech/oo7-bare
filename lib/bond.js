...
// All names we are subscribing to
const subscripted = {};
...
Bond.knowSymbol = function (name) {
	return !!subscripted[name];
};

Bond.fromSymbol = function (name) {
	const sub = subscripted[name];
 ...
 */
Bond.all = function (list, resolveDepth = 1) {
 ...
 * that a {@link Bond} may be for it to be resolved.
 */
Bond.mapAll = function (list, transform, outResolveDepth = 0, resolveDepth = 1) {
